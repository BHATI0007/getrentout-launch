      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "56px 24px 90px" }}>
        ...
        <Section n="3." title="When and how you're paid">
          <ul style={{ padding: 0, margin: 0 }}>
            ...
            <Li><strong style={{ color: "#c0c0e0" }}>Payout schedule.</strong> Confirmed earnings are paid <strong style={{ color: "#c0c0e0" }}>once a month</strong>, for the previous month, once your confirmed balance reaches the <strong style={{ color: "#c0c0e0" }}>minimum payout of US$10</strong> (or local equivalent). Balances below the minimum roll over to the next month.</Li>
            <Li><strong style={{ color: "#c0c0e0" }}>Payout method.</strong> The payout methods available for your country (for example, UPI in India) are confirmed with you before your first payout. Currency-conversion and payment-processor fees, if any, are your responsibility.</Li>
